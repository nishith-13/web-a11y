...
page('/lesson2-focus/03-managing-focus/index.html', function () {
  page.redirect('/lesson2-focus/03-managing-focus/index.html/what-is-vegemite');
});

page('/lesson2-focus/03-managing-focus/:slug', function (context) {
